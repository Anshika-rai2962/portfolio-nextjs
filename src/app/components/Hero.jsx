        ...
        <div className="grid md:grid-cols-2 gap-12 items-center min-h-[calc(100vh-120px)]">
          ...
          <div className="flex flex-col justify-center">
            <div className="mb-6">
              ...
              <div className="flex items-center gap-3">
                <h2 className="text-4xl md:text-5xl font-bold text-black dark:text-white">
                  I'm <span>Anshika </span><span className="text-orange-500 dark:bg-gradient-to-br dark:from-teal-300 dark:via-yellow-300 dark:to-pink-300 dark:bg-clip-text dark:text-transparent">Rai</span>
                </h2>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-8">
              <a
                href="https://www.linkedin.com/in/anshika-rai-b71bb2272/"
                target="_blank"
              ...
              >
               ...
               <a
                href="https://www.instagram.com/iamanshikaraii/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white hover:bg-purple-600 hover:text-white dark:hover:bg-purple-600 transition-all duration-300"
              >
              ...
              <a
                href="https://x.com/rai_anshik14467"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white hover:bg-purple-600 hover:text-white dark:hover:bg-purple-600 transition-all duration-300"
              >
              ...
              <a
                href="https://github.com/Anshika-rai2962"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white hover:bg-purple-600 hover:text-white dark:hover:bg-purple-600 transition-all duration-300"
              >
          ...
          <div className="flex justify-center items-center">
            ...
            >
              ...
              <div className="w-90 h-90 rounded-full p-3 bg-gradient-to-br from-teal-300 via-yellow-300 to-pink-300 shadow-2xl relative z-20 flex items-center justify-center">
                <div className="w-80 h-80 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center overflow-hidden">
                  <img
                    src="/image/Anshika_avatar1.png"
                    alt="Avatar"
                    className="avatar-image w-110 h-100 rounded-full object-contain object-center"
                  />
                </div>
              </div>
            </div>
